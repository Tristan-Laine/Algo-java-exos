...
public class Main {
    ...
    static void FonctionScore (int Tableau []) {            //Création fonctionScore
        for (int i = 0; i < Tableau.length; i++) {          //Création boucle for
            int score1 = Tableau[i];                        //Score1 prend la valeur du tableau en i
        ...
        static void FonctionMoyenne (int Moy []){           //Création fonctionMoyenne
        ...
        static int FonctionPlusGrandNB (int Nombre []){     //Création fonctionPlusGrandNB
        ...
        static boolean FonctionValeur10 (int Valeur []){    //Création FonctionValeur10
